...
\author{\firstname{Xavier} \lastname{Espinal}\inst{1} \and
        \firstname{Stephane} \lastname{Jezequel}\inst{2} \and
        \firstname{Markus} \lastname{Schulz}\inst{1} \and
        \firstname{Andrea} \lastname{Sciaba}\inst{1} \and
        \firstname{Ilija} \lastname{Vukotic}\inst{3} \and
        \firstname{Frank} \lastname{Wuerthwein}\inst{4}
}
